...
```
    ...
    [[{'end_time': 0.02, 'phoneme': 'ɪ', 'start_time': 0.0},
      {'end_time': 0.3, 'phoneme': 't', 'start_time': 0.26},
      {'end_time': 0.36, 'phoneme': 'ɪ', 'start_time': 0.34},
      {'end_time': 0.44, 'phoneme': 'z', 'start_time': 0.42},
      {'end_time': 0.54, 'phoneme': 'n', 'start_time': 0.5},
      {'end_time': 0.58, 'phoneme': 'oʊ', 'start_time': 0.54},
      {'end_time': 0.62, 'phoneme': 't', 'start_time': 0.58},
      {'end_time': 0.78, 'phoneme': 'ʌ', 'start_time': 0.76},
      {'end_time': 0.94, 'phoneme': 'p', 'start_time': 0.92}]]
